        ...
        <div class="container col-sm-6 d-flex flex-column justify-content-center align-items-center">
            <section class="col-sm-9">
                ...
                <form action="">
                    ...
                    <div>
                        <label for="curriculo" class="fw-normal">Anexe seu currículo</label>
                        <input type="file" name="curriculo" id="curriculo" required class="form-control shadow-sm" placeholder="Anexe seu currículo">
                        <p class="text-center  mb-2">*O arquivo deve ser no formato PDF</p>
                    </div>
                    <button class="btn btn-submit w-100 mb-2" id="btn-custom">Cadastre-se</button>
                    <a href="cadastro.php" class="links" >Voltar <i class="bi bi-caret-right-fill"></i></a>
                </form>
            </section>
        </div>
    </div>
